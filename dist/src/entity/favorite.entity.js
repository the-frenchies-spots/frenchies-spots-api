...
__decorate([
    ...
    (0, typeorm_1.ManyToOne)(() => profile_entity_1.ProfileEntity, (profile) => profile.favorites, {
        onDelete: 'CASCADE',
    }),
    __metadata("design:type", profile_entity_1.ProfileEntity)
], FavoriteEntity.prototype, "profile", void 0);
__decorate([
    (0, graphql_1.Field)(),
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], FavoriteEntity.prototype, "profileId", void 0);
__decorate([
    (0, graphql_1.Field)(() => spot_entity_1.SpotEntity),
    (0, typeorm_1.ManyToOne)(() => spot_entity_1.SpotEntity, (spot) => spot.favorites, {
        onDelete: 'CASCADE',
    }),
    __metadata("design:type", spot_entity_1.SpotEntity)
], FavoriteEntity.prototype, "spot", void 0);
__decorate([
    (0, graphql_1.Field)(),
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], FavoriteEntity.prototype, "spotId", void 0);
__decorate([
    (0, graphql_1.Field)(),
